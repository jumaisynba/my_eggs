...
void URutil::send_speeds()
{
    ...
    for(int i=0; i< 6; i++)
  {
    ...
    if (i == 2){
      ...
      if (joint_values_.at(i) > -0.78)
      {
	   joint_init_velocities_[i]=-0.1;
      }
      else if (joint_values_.at(i) < -0.78)
      {
	 joint_init_velocities_[i]=0.1;
      }      
      if ((joint_values_.at(i) < -0.775)&&(joint_values_.at(i) > -0.785 ))
      {
	joint_init_velocities_[i]=0;
      }
    }
    // base lift 45 deg 
      ...
      if (joint_values_.at(i) < -2.35)
      {
	   joint_init_velocities_[i]= 0.04;
      }
      else if (joint_values_.at(i) > -2.35)
      {
	 joint_init_velocities_[i]= -0.04;
      }      
      if ((joint_values_.at(i) < -2.34)&&(joint_values_.at(i) > -2.36 ))
      {
	joint_init_velocities_[i]=0;
      }
    }
	 ...
	 joint_init_velocities_[i]=0.157;
      ...
      if ((joint_values_.at(i) < 1.575)&&(joint_values_.at(i) > 1.565 ))
      {
	joint_init_velocities_[i]=0;
      }
	    }
	 ...
	 joint_init_velocities_[i]=0.157;
      ...
      if ((joint_values_.at(i) < 0.79)&&(joint_values_.at(i) > 0.77 ))
      {
	joint_init_velocities_[i]=0;
      }
    }
//                  if (i == 5){
//       
//       if (joint_values_.at(i) > 0.98)
//       {
// 	   joint_init_velocities_[i]= -0.157;
//       }
//       else if (joint_values_.at(i) < 0.98)
//       {
// 	 joint_init_velocities_[i]=0.157;
//       }      
//       if ((joint_values_.at(i) < 0.99)&&(joint_values_.at(i) > 0.97 ))
//       {
// 	joint_init_velocities_[i]=0;
//       }
//     }
