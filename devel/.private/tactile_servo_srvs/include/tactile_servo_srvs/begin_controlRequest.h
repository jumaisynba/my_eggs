...
bool operator==(const ::tactile_servo_srvs::begin_controlRequest_<ContainerAllocator1> & lhs, const ::tactile_servo_srvs::begin_controlRequest_<ContainerAllocator2> & rhs)
{
  return lhs.begin_control == rhs.begin_control;
}
