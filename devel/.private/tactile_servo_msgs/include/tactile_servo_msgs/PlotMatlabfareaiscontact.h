...
bool operator==(const ::tactile_servo_msgs::PlotMatlabfareaiscontact_<ContainerAllocator1> & lhs, const ::tactile_servo_msgs::PlotMatlabfareaiscontact_<ContainerAllocator2> & rhs)
{
