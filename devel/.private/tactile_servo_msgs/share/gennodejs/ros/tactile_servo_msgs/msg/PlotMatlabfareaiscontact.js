...
class PlotMatlabfareaiscontact {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('iscontact')) {
        this.iscontact = initObj.iscontact
      }
      else {
        this.iscontact = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [iscontact]
    bufferOffset = _serializer.float64(obj.iscontact, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PlotMatlabfareaiscontact(null);
    ...
    // Deserialize message field [iscontact]
    data.iscontact = _deserializer.float64(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlotMatlabfareaiscontact(null);
    ...
    if (msg.iscontact !== undefined) {
      resolved.iscontact = msg.iscontact;
    }
    else {
      resolved.iscontact = 0.0
    }
...
module.exports = PlotMatlabfareaiscontact;
